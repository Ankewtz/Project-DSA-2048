...
public class Game {
    ...
    public void executeMove(int moveValue) {
        if (!moving && !hasMoved) {
    ...
    private void movingGreedyAI() {
        ...
        int moveValue = greedyAI.getNextMove(board);
